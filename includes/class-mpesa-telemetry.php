...
register_activation_hook(WC_MPESA_TILL_PLUGIN_DIR . 'mpesa-till-gateway.php', array('Mpesa_Telemetry', 'track_activation'));
register_deactivation_hook(WC_MPESA_TILL_PLUGIN_DIR . 'mpesa-till-gateway.php', array('Mpesa_Telemetry', 'track_deactivation'));
